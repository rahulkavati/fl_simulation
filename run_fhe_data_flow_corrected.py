"""
Fixed FHE CKKS Data Flow with Correct Global Model Evaluation
Evaluates the global model instead of local model for accurate performance metrics
"""
...
def create_balanced_synthetic_data():
    """
    Create balanced synthetic data to ensure both classes are present
    """
    print("📊 Creating Balanced Synthetic Health Data...")
    ...
    print(f"✅ Created {len(df)} balanced samples for {df['participant_id'].nunique()} participants")
...
def run_fhe_data_flow_with_correct_evaluation():
    """
    Run the complete FHE CKKS data flow with correct global model evaluation
    """
    print("🚀 RUNNING FHE CKKS DATA FLOW WITH CORRECT GLOBAL MODEL EVALUATION")
    print("="*80)
    
    # Step 1: Create balanced synthetic data
    print("\n📊 STEP 1: Creating Balanced Synthetic Data")
    print("-" * 40)
    df = create_balanced_synthetic_data()
    ...
    # Step 7: Run federated learning rounds with correct evaluation
    print("\n🔄 STEP 7: Running Federated Learning Rounds with Correct Global Model Evaluation")
    print("-" * 80)
    ...
    for round_num in range(1, fl_config.rounds + 1):
        ...
        # Phase 6: Evaluate GLOBAL MODEL performance (CORRECTED)
        ...
        # Create test data from ALL smartwatches (not just one)
        all_test_data = []
    ...
    results_summary = {
        'experiment_info': {
            ...
            'data_source': 'balanced_synthetic_data',
...
if __name__ == "__main__":
    print("🚀 FHE CKKS DATA FLOW WITH CORRECT GLOBAL MODEL EVALUATION")
    print("="*80)
    
    # Run the complete data flow
    results = run_fhe_data_flow_with_correct_evaluation()
    
    if results:
        print("\n🎉 DATA FLOW COMPLETED SUCCESSFULLY!")
        print("✅ Balanced synthetic data loaded")
